...
$(document).ready(function () {
  $('#fullpage').fullpage({
    licenseKey: 'KCWL6-31VLK-MK4RI-UJH67-OZJJL',
    scrollBar: true,
    scrollingSpeed: 600,
    recordHistory: false,
    paddingTop: '3.5rem',
...
(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.lineHeight = f() } })(function () {
...
function animateLP(direction) {
  console.log("Animate");
  var distance = direction * window.innerHeight;
